...
class BoardOutException(BoardException):
    def __str__(self):
        return 'Зафиксирована ошибка. Выход за пределы доски!'


class BoardUsedException(BoardException):
    def __str__(self):
        return 'Зафиксирована ошибка. В эту клетку уже был произведен выстрел!'
...
class Game:
    def __init__(self, size=6):
        ...
        self.ai = Computer(computer_board, user_board)
        self.pl = User(user_board, computer_board)
